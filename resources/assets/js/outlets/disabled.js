...
$(function () {
  ...
  var dt_outlet_table = $('.datatables-outlets-disabled'),
    select2 = $('.select2'),
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'DELETE',
          url: `${baseUrl}disabled-outlets-list/${outlet_id}`,
          success: function () {
            dt_outlet.draw();
          },
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    // Get data
    $.get(`${baseUrl}disabled-outlets-list/${outlet_id}/edit`, function (data) {
  ...
  $(document).on('click', '.activate-record', function (e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'PATCH',
          url: `${baseUrl}disabled-outlets-list/${outlet_id}/activation`,
