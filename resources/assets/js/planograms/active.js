...
$(function () {
  ...
  var dt_planogram_table = $('.datatables-planograms-active'),
    select2 = $('.select2'),
  ...
  if (dt_planogram_table.length) {
    var dt_planogram = dt_planogram_table.DataTable({
      ...
      serverSide: true,
      ajax: {
        url: baseUrl + 'active-planograms-list'
      },
      columns: [
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'DELETE',
          url: `${baseUrl}active-planograms-list/${planogram_id}`,
          success: function () {
            dt_planogram.draw();
          },
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    // Get data
    $.get(`${baseUrl}active-planograms-list/${planogram_id}/edit`, function (data) {
  ...
  $(document).on('click', '.activate-record', function (e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'PATCH',
          url: `${baseUrl}active-planograms-list/${planogram_id}/activation`,
  ...
  $(document).on('click', '.suspend-record', function (e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'PATCH',
          url: `${baseUrl}active-planograms-list/${planogram_id}/suspension`,
          data: { status: new_status },
          success: function () {
            dt_planogram().draw();
          },
