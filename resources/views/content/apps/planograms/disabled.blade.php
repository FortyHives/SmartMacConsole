...
@section('title', 'Disabled Planograms')
...
<!-- Page Scripts -->
@section('page-script')
  @vite('resources/assets/js/planograms/disabled.js')
@endsection
...
@section('content')
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <div class="me-1">
              <p class="text-heading mb-1">Planograms</p>
              <div class="d-flex align-items-center">
                <h4 class="mb-1 me-2">{{$totalDisabledPlanograms}}</h4>
                <p class="text-success mb-1">({{$disabledPercentage}})</p>
              </div>
              <small class="mb-0">Total count of disabled planograms</small>
            </div>
            <div class="avatar">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <div class="me-1">
              ...
              <small class="mb-0">Total count of disabled suspended planograms</small>
            </div>
            <div class="avatar">
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-planograms-disabled table">
        <thead>
        <tr>
          <th></th>
          <th>Id</th>
