...
<!-- Page Scripts -->
@section('page-script')
  @vite('resources/assets/js/outlets/new.js')
@endsection
...
@section('content')
          ...
          <div class="d-flex justify-content-between">
            <div class="me-1">
              ...
              <div class="d-flex align-items-center">
                <h4 class="mb-1 me-2">{{$totalNewOutlets}}</h4>
                <p class="text-success mb-1">({{$newPercentage}})</p>
              </div>
              <small class="mb-0">Total count of new outlets</small>
            </div>
            <div class="avatar">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <div class="me-1">
              ...
              <small class="mb-0">Total count of verified new outlets</small>
            </div>
            <div class="avatar">
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-outlets-new table">
        <thead>
        <tr>
          <th></th>
          <th>Id</th>
