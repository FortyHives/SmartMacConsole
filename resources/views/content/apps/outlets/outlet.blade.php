...
@section('content')
        ...
        <div class="card-body pt-12">
          <div class="user-avatar-section">
            <div class=" d-flex align-items-center flex-column">
              ...
              <div class="user-info text-center">
                <h5>{{ $outlet->name[0] }} {{ $outlet->name[1] }} {{ $outlet->name[2] }}</h5>
          ...
          <div class="info-container">
            ...
            <div class="d-flex justify-content-center">
              <a href="javascript:;" class="btn btn-primary me-4" data-bs-target="#editOutlet"
                 data-bs-toggle="modal">Edit</a>
              <a href="javascript:;" class="btn btn-outline-danger suspend-outlet">Suspend</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal fade" id="editOutlet" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-outlet">
      <div class="modal-content">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="modal-body p-0">
          <div class="text-center mb-6">
            <h4 class="mb-2">Edit Outlet Information</h4>
            <p class="mb-6">Updating outlet details will receive a privacy audit.</p>
          </div>
          <form id="editOutletForm" class="row g-5" onsubmit="return false">
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditOutletFirstName" name="modalEditOutletFirstName" class="form-control" value="Oliver" placeholder="Oliver" />
                <label for="modalEditOutletFirstName">First Name</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditOutletLastName" name="modalEditOutletLastName" class="form-control" value="Queen" placeholder="Queen" />
                <label for="modalEditOutletLastName">Last Name</label>
              </div>
            </div>
            <div class="col-12">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditOutletName" name="modalEditOutletName" class="form-control" value="oliver.queen" placeholder="oliver.queen" />
                <label for="modalEditOutletName">Outletname</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditOutletEmail" name="modalEditOutletEmail" class="form-control" value="oliverqueen@gmail.com" placeholder="oliverqueen@gmail.com" />
                <label for="modalEditOutletEmail">Email</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <select id="modalEditOutletStatus" name="modalEditOutletStatus" class="form-select" aria-label="Default select example">
                  <option value="1" selected>Active</option>
                  <option value="2">Inactive</option>
                  <option value="3">Suspended</option>
                </select>
                <label for="modalEditOutletStatus">Status</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
            ...
            <div class="col-12 col-md-6">
              <div class="input-group input-group-merge">
                ...
                <div class="form-floating form-floating-outline">
                  <input type="text" id="modalEditOutletPhone" name="modalEditOutletPhone" class="form-control phone-number-mask" value="+1 609 933 4422" placeholder="+1 609 933 4422" />
                  <label for="modalEditOutletPhone">Phone Number</label>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <select id="modalEditOutletCountry" name="modalEditOutletCountry" class="select2 form-select" data-allow-clear="true">
                ...
                <label for="modalEditOutletCountry">Country</label>
              </div>
            </div>
            <div class="col-12">
