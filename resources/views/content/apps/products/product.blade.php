        ...
        <div class="card-body pt-12">
          <div class="user-avatar-section">
            <div class=" d-flex align-items-center flex-column">
              ...
              <div class="user-info text-center">
                <h5>{{ $product->name[0] }} {{ $product->name[1] }} {{ $product->name[2] }}</h5>
          ...
          <div class="info-container">
            ...
            <div class="d-flex justify-content-center">
              <a href="javascript:;" class="btn btn-primary me-4" data-bs-target="#editProduct"
                 data-bs-toggle="modal">Edit</a>
              <a href="javascript:;" class="btn btn-outline-danger suspend-product">Suspend</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body p-0">
          <div class="text-center mb-6">
            ...
            <p class="mb-6">Updating product details will receive a privacy audit.</p>
          </div>
          <form id="editProductForm" class="row g-5" onsubmit="return false">
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditProductFirstName" name="modalEditProductFirstName" class="form-control" value="Oliver" placeholder="Oliver" />
                <label for="modalEditProductFirstName">First Name</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditProductLastName" name="modalEditProductLastName" class="form-control" value="Queen" placeholder="Queen" />
                <label for="modalEditProductLastName">Last Name</label>
              </div>
            </div>
            <div class="col-12">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditProductName" name="modalEditProductName" class="form-control" value="oliver.queen" placeholder="oliver.queen" />
                <label for="modalEditProductName">Productname</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <input type="text" id="modalEditProductEmail" name="modalEditProductEmail" class="form-control" value="oliverqueen@gmail.com" placeholder="oliverqueen@gmail.com" />
                <label for="modalEditProductEmail">Email</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <select id="modalEditProductStatus" name="modalEditProductStatus" class="form-select" aria-label="Default select example">
                  <option value="1" selected>Active</option>
                  <option value="2">Inactive</option>
                  <option value="3">Suspended</option>
                </select>
                <label for="modalEditProductStatus">Status</label>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
            ...
            <div class="col-12 col-md-6">
              <div class="input-group input-group-merge">
                ...
                <div class="form-floating form-floating-outline">
                  <input type="text" id="modalEditProductPhone" name="modalEditProductPhone" class="form-control phone-number-mask" value="+1 609 933 4422" placeholder="+1 609 933 4422" />
                  <label for="modalEditProductPhone">Phone Number</label>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
              <div class="form-floating form-floating-outline">
                <select id="modalEditProductCountry" name="modalEditProductCountry" class="select2 form-select" data-allow-clear="true">
                ...
                <label for="modalEditProductCountry">Country</label>
              </div>
            </div>
            <div class="col-12">
